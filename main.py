...
if args.task=='MNIST':
    transform = torchvision.transforms.Compose([torchvision.transforms.ToTensor(), 
                                                torchvision.transforms.Normalize(mean=(0.0,), std=(1.0,))]) # TODO double check this normalisation is good for OIMs
...
# TODO check about what activation functions to use for OIMs
if args.act=='mysig':
...
if args.load_path=='': # i.e. if no model is loaded
    ...
    if args.model=='MLP':
        model = P_MLP(args.archi, activation=activation) # P_MLP means MLP defined using primitive function
